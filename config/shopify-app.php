...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_product_listings'),
    ...
    'webhooks' => [
        ...
        */
        ...
        [
            ...
            'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS','https://tiktok.lifted-apps.net/public/webhook/app-uninstalled')
        ]
    ],
